...
import { Plane, Shield, Users, Activity, Camera } from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="px-3 py-2.5 border-b border-(--border-primary) flex items-center gap-2">
        ...
        <span className="text-[11px] font-mono font-bold tracking-[0.15em] text-(--text-heading)">ACTIVE LAYERS</span>
      </div>
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="text-[10px] font-mono font-bold" style={{ color: active ? layer.color : 'var(--text-muted)' }}>
                  {layer.label}
                </div>
