...
const SITE_NAME = "NAKIME";
const SITE_TITLE = "NAKIME — Open Source Intelligence Platform | Live Flight Tracking, CCTV, OSINT Tools & More";
...
export const metadata: Metadata = {
  ...
  title: {
    default: SITE_TITLE,
    template: "%s | NAKIME Intelligence",
  },
  ...
  keywords: [
    ...
    // Brand
    "nakime", "nakimeai", "nakimeai.live",
  ],
  authors: [{ name: "Nakime Project", url: SITE_URL }],
  creator: "Nakime Project",
  publisher: "Nakime Project",
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  openGraph: {
    title: "NAKIME — The Open-Source Palantir Alternative | Live Flights, CCTV, Satellites & OSINT Tools",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "NAKIME — Open Source Intelligence Platform with Live Tracking & OSINT Tools",
        type: "image/png",
      },
    ],
  },
  ...
  other: {
    ...
    "apple-mobile-web-app-title": "NAKIME",
...
const jsonLd = {
  ...
  "@type": "WebApplication",
  name: "NAKIME — OSINT Toolkit & Intelligence Platform",
  alternateName: ["NAKIME", "NakimeAI", "Nakime OSINT"],
  url: SITE_URL,
  description: SITE_DESCRIPTION,
  ...
  return (
    <html lang="en" dir="ltr">
      ...
      <body className="antialiased">
        <ErrorBoundary name="NAKIME Core">
          {children}
        </ErrorBoundary>
      </body>
    </html>
