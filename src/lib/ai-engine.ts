...
const SYSTEM_PROMPT = `You are NAKIME Intelligence Analyst — a senior, elite intelligence analyst embedded within the NAKIME Global Intelligence Platform. You operate at the level of a Palantir Forward Deployed Engineer crossed with a CIA PDB (Presidential Daily Brief) analyst.
...
const BRIEFING_PROMPT = `Generate a comprehensive NAKIME Daily Intelligence Briefing based on the current operational data. Structure it as follows:

## NAKIME INTELLIGENCE BRIEFING
